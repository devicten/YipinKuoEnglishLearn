import { version, unref, inject, defineComponent, ref, provide, createElementBlock, computed, watch, h, shallowReactive, Suspense, nextTick, Fragment, Transition, hasInjectionContext, getCurrentInstance, mergeProps, useSSRContext, createApp, effectScope, reactive, getCurrentScope, defineAsyncComponent, onErrorCaptured, onServerPrefetch, toRef, isRef, isReactive, toRaw, createVNode, resolveDynamicComponent, onScopeDispose, shallowRef, isReadonly, markRaw, toRefs, isShallow, withCtx } from 'vue';
import { $ as $fetch, w as withQuery, q as hasProtocol, t as isScriptProtocol, v as joinURL, x as defu, y as sanitizeStatusCode, z as createHooks, n as createError$1, A as toRouteMatcher, B as createRouter$1, C as klona, D as parse$1, E as getRequestHeader, F as destr, G as isEqual, s as setCookie, g as getCookie, a as deleteCookie } from '../runtime.mjs';
...
const AppComponent = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender$2], ["__file", "/home/runner/YipinKuoEnglishLearn/app.vue"]]);
const _sfc_main$1 = {
  ...
  setup(__props, { expose: __expose }) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-B3f4YNuW.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-Q0ESPKCC.mjs').then((r) => r.default || r));
...
const ErrorComponent = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__file", "/home/runner/YipinKuoEnglishLearn/node_modules/nuxt/dist/app/components/nuxt-error-page.vue"]]);
const _sfc_main = {
  __name: "nuxt-root",
  setup(__props, { expose: __expose }) {
    __expose();
...
const RootComponent = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__file", "/home/runner/YipinKuoEnglishLearn/node_modules/nuxt/dist/app/components/nuxt-root.vue"]]);
let entry;
{
