...
import { H as parseQuery, q as hasProtocol, v as joinURL, w as withQuery, I as withTrailingSlash, J as withoutTrailingSlash } from '../runtime.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "font-sans antialiased bg-white dark:bg-black text-black dark:text-white grid min-h-screen place-content-center overflow-hidden" }, _attrs))} data-v-fdc70557><div class="fixed left-0 right-0 spotlight z-10" data-v-fdc70557></div><div class="max-w-520px text-center z-20" data-v-fdc70557><h1 class="text-8xl sm:text-10xl font-medium mb-8" data-v-fdc70557>${ssrInterpolate($props.statusCode)}</h1><p class="text-xl px-8 sm:px-0 sm:text-4xl font-light mb-16 leading-tight" data-v-fdc70557>${ssrInterpolate($props.description)}</p><div class="w-full flex items-center justify-center" data-v-fdc70557>`);
...
const error404 = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-fdc70557"], ["__file", "/home/runner/YipinKuoEnglishLearn/node_modules/nuxt/dist/app/components/error-404.vue"]]);

export { error404 as default };
//# sourceMappingURL=error-404-B3f4YNuW.mjs.map
