...
import { e as eventHandler, b as setResponseHeader, c as send, f as getResponseStatus, h as setResponseStatus, i as useNitroApp, j as setResponseHeaders, k as joinRelativeURL, u as useRuntimeConfig, l as getQuery, n as createError, o as getRouteRules, p as getResponseStatusText } from '../runtime.mjs';
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":""}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}],"style":[],"script":[],"noscript":[],"title":"Kingslish","htmlAttrs":{"lang":"zh-tw"}};
